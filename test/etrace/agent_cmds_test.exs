defmodule ETrace.AgentCmds.Test do
  use ExUnit.Case
  alias ETrace.{AgentCmds, Probe}
  ...
  test "trace local function" do
    ...
    probe = Probe.new(
                ...
                match_by: local do ETrace.AgentCmds.Test.local_function(a) -> message(a) end)
    ...
    assert_receive({:trace_ts, ^my_pid, :call,
      {ETrace.AgentCmds.Test, :local_function, 1}, [[:a, 1]], _})
